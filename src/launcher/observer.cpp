...
public:
  ...
  virtual ~ObserverExecutorProcess() {}
...
public:
  ...
  {
    dispatch(process,
             &ObserverExecutorProcess::registered,
             driver,
             executorInfo,
             frameworkInfo,
             slaveInfo);
  ...
  {
    dispatch(process,
             &ObserverExecutorProcess::reregistered,
             driver,
             slaveInfo);
  }
  ...
  {
    dispatch(process, &ObserverExecutorProcess::disconnected, driver);
  }

  virtual void launchTask(ExecutorDriver* driver, const TaskInfo& task)
  {
    dispatch(process, &ObserverExecutorProcess::launchTask, driver, task);
  }

  virtual void killTask(ExecutorDriver* driver, const TaskID& taskId)
  {
    dispatch(process, &ObserverExecutorProcess::killTask, driver, taskId);
  }

  virtual void frameworkMessage(ExecutorDriver* driver, const string& data)
  {
    dispatch(process, &ObserverExecutorProcess::frameworkMessage, driver, data);
  }

  virtual void shutdown(ExecutorDriver* driver)
  {
    dispatch(process, &ObserverExecutorProcess::shutdown, driver);
  }

  virtual void error(ExecutorDriver* driver, const string& data)
  {
    dispatch(process, &ObserverExecutorProcess::error, driver, data);
  }

private:
  ObserverExecutorProcess* process;
};
